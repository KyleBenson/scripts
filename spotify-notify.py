...
#Kyle Benson edit: I put the actual spotify binary in this location so opening spotify will trick the system into opening spotify-notify first.
SPOTIFY_PROCESS_NAME = os.path.join(APPLICATION_DIR, 'spotify-client')
